...
class PlaylistRepository {
  ...
  /// Removes the auto-generated playlist tied to [sourceVibeTagId], if any.
  ///
  /// Call this *before* deleting the vibe tag itself — the tag's `onDelete:
  /// setNull` foreign key would otherwise clear `sourceVibeTagId` first,
  /// making the orphaned playlist impossible to find afterward.
  Future<void> deleteAutoPlaylistForVibeTag(String sourceVibeTagId) async {
    final existing =
        await (_database.select(_database.playlists)
              ..where((t) => t.sourceVibeTagId.equals(sourceVibeTagId)))
            .getSingleOrNull();
    if (existing != null) {
      await (_database.delete(
        _database.playlists,
  ...
  /// is empty (SRS F-4.2: auto-generated vibe playlists).
  Future<void> replaceAutoPlaylistSongs({
    required String sourceVibeTagId,
        ...
        await _database
            ...
            .insert(
              PlaylistsCompanion.insert(
                ...
                sourceVibeTagId: Value(sourceVibeTagId),
              ),
            );
      } else {
        await (_database.update(_database.playlists)
  ...
  /// auto-generated vibe playlists, which regenerate themselves), used by
  /// `BackupRepository`.
